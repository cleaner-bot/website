...
export default function DashboardWrapper() {
    ...
    return (
        <>
            <MetaTags title="Branding | The Cleaner Dashboard" />
...
function BrandingDashboard({
    ...
    return (
        <>
            <Header name="Branding">Control your brand.</Header>
            <Section>
                <ToggleBlock
                    name="Enable splash"
                ...
                >
                    {entitlements.plan >= entitlements.branding_splash && (
                        <>
                            <ExternalLink
                                href={`https://cdn.cleanerbot.xyz/splash/${guildId}`}
