...
export default function DashboardWrapper() {
    ...
    return (
        <>
            <MetaTags title="Workers | The Cleaner Dashboard" />
...
function WorkersDashboard({ config, setConfig, entitlements, guildId }) {
    ...
    return (
        <>
            <Header name="Workers">Manage your worker.</Header>
            <Section>
                <ToggleBlock
                    name="Enable workers"
                ...
                {config.workers_enabled && (
                    <>
                        <PlainBlock
                            ...
                            description={
                                <>
                                    Type your worker code. It is currently not
                                    possible to retrieve your worker&apos;s
                                    source.{" "}
