...
export default function DashboardWrapper() {
    ...
    return (
        <>
            <MetaTags title="Anti Raid | The Cleaner Dashboard" />
    ...
    return (
        <>
            <Header name="Anti Raid">
                Anti Raid settings. This is recommended for small server. Big
                servers should take a look at{" "}
                <Link href={`/dash/${guildId}/verification`}>
