...
function GuildList({ response, query }) {
    ...
    const servers = response && [...response.data].sort((a, b) => [b.is_suspended - a.is_suspended, b.is_added - a.is_added, a.access_type - b.access_type, b.name.toLowerCase() > a.name.toLowerCase() ? -1 : 1].find(x => x !== 0));
    return (
