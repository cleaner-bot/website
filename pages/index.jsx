...
const trustedBy = [
    { name: "Servers", count: "120+" },
    { name: "Users", count: "190,000+" },
];
        ...
        <>
                ...
                <div className="grid grid-cols-1 gap-10 mt-20 sm:mt-40 xl:grid-cols-2">
                    <div className="m-auto">
                        ...
                        <p className="mt-6 text-gray-100">
                            ...
                            server clean by removing spam, phishing, and more!
                        </p>
                        <div className="my-4 space-y-1">
                            <Pro>Spam detection within seconds.</Pro>
                            <Pro>
                                Instant phishing link detection with the help of
                                heuristics, a database of old links and shared
                                knowledge between servers.
                            </Pro>
                            <Pro>
                        ...
                        <div className="grid gap-2 mt-2 md:grid-cols-2">
                            <InternalLink href="/dash">Dashboard</InternalLink>
                    ...
                    <div className="m-auto">
                        ...
                        <p className="mt-6 text-gray-100">
                            The Cleaner is trusted by many servers and users to
                            keep their environment clean.
                        </p>
                        <p className="font-bold text-gray-300 hover:underline">
                            <Link href="/radar">
                                <a>
                                    Find the exact numbers and more statistics
                                    here.
                                </a>
                            </Link>
                        </p>
                        <div className="grid px-4 mt-12 text-center sm:grid-cols-2 sm:text-left">
                            {trustedBy.map(({ name, count }) => (
                                <div key={name}>
                                    <p className="text-lg font-medium text-gray-350">
                                        {name}
                                    </p>
            ...
            <div className="text-gray-750 mt-[50vh]">
                ...
                >
                    <path
                        fillOpacity="1"
                        d="M0,224L48,197.3C96,171,192,117,288,80C384,43,480,21,576,32C672,43,768,85,864,122.7C960,160,1056,192,1152,197.3C1248,203,1344,181,1392,170.7L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
                    ></path>
                </svg>
            </div>
            ...
            <div className="my-40 --container" data-aos="fade-up">
                <h2 className="text-6xl font-bold leading-[3rem] text-center max-w-[30rem] lg:max-w-none mx-auto">
                    Start protecting{" "}
                    <span className="text-blue-300">your server</span> now
                </h2>
                <InternalLink
                    href="/dash"
                    className="mx-auto max-w-[27rem] lg:max-w-[56rem] mt-12"
                >
                    Dashboard
                </InternalLink>
            </div>
            <div className="mt-20 text-gray-750">
                ...
                >
                    <path
                        fillOpacity="1"
                        d="M0,256L48,213.3C96,171,192,85,288,80C384,75,480,149,576,154.7C672,160,768,96,864,90.7C960,85,1056,139,1152,154.7C1248,171,1344,149,1392,138.7L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
                    ></path>
                </svg>
            </div>
            <div className="bg-gray-750">
