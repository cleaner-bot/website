...
export function postFilterRule(guildId, phase) {
    return AXIOS.post(`/v1/guild/${guildId}/filterrules/${phase}`);
}

export function patchFilterRule(guildId, phase, index, data) {
    return AXIOS.patch(
        `/v1/guild/${guildId}/filterrules/${phase}/${index}`,
        data
    );
}
