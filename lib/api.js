...
export function postChallenge(flow, captcha) {
    return AXIOS.post("/challenge", { flow, captcha })
}

/* Verification */

export function postVerification(guild_id, captcha) {
    return AXIOS.post("/verification", undefined, { params: { guild_id, captcha } })
}
