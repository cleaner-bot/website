...
export function getOwnBanSyncLists(guildId) {
    return AXIOS.get(`/v1/guild/${guildId}/bansync`);
}

export function postBanSyncList(guildId) {
    return AXIOS.post(`/v1/guild/${guildId}/bansync`);
}

export function patchBanSyncList(guildId, banListId, body) {
    return AXIOS.patch(`/v1/guild/${guildId}/bansync/${banListId}`, body);
}

export function deleteBanSyncList(guildId, banListId) {
    return AXIOS.delete(`/v1/guild/${guildId}/bansync/${banListId}`);
}

export function postBanListImport(guildId, banListId) {
    return AXIOS.post(`/v1/guild/${guildId}/bansync/${banListId}/import`);
}

export function getBanListUsers(guildId, banListId) {
    return AXIOS.get(`/v1/guild/${guildId}/bansync/${banListId}/users`);
}

export function addBanListUsers(guildId, banListId, users) {
    return AXIOS.post(`/v1/guild/${guildId}/bansync/${banListId}/users`, users);
}

export function deleteBanListUsers(guildId, banListId, users) {
...
export function getBanLists(banListIds) {
    const query = new URLSearchParams();
    for (const id of banListIds) query.append("id", id);
    return AXIOS.get(`/v1/bansync?${query.toString()}`);
}
